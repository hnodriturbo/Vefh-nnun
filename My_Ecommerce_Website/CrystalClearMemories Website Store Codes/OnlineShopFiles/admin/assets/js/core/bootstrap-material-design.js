(function (e, t) {
    ...
    var l = (function (e) {
        ...
        s = (function (e) {
            ...
            return (
                e(document).on(i.CLICK_DATA_API, { DISMISS: '[data-dismiss="alert"]' }.DISMISS, d._handleDismiss(new d())),
        ...
        c = (function (e) {
            var t = "carousel",
                ...
                p = { SLIDE: "slide" + r, SLID: "slid" + r, KEYDOWN: "keydown" + r, MOUSEENTER: "mouseenter" + r, MOUSELEAVE: "mouseleave" + r, TOUCHEND: "touchend" + r, LOAD_DATA_API: "load" + r + i, CLICK_DATA_API: "click" + r + i },
                        ...
                        (s._slide = function (t, n) {
                            ...
                            if (!E.isDefaultPrevented() && s && c) {
                                ...
                                l.supportsTransitionEnd() && e(this._element).hasClass(m.SLIDE)
                                    ...
                                    : (e(s).removeClass(m.ACTIVE), e(c).addClass(m.ACTIVE), (this._isSliding = !1), e(this._element).trigger(h)),
                                    u && this.cycle();
                            }
                        }),
                            ...
                            if (!(this._isTransitioning || e(this._element).hasClass(p.SHOW))) {
                                ...
                                if (
                                    (this._parent &&
                                        ...
                                        0 === o.length && (o = null)),
                                    !(o && ((a = e(o).not(this._selector).data(n)), a && a._isTransitioning)))
                                ) {
                                    ...
                                    if ((e(this._element).trigger(i), !i.isDefaultPrevented())) {
                                        ...
                                        e(this._element).removeClass(p.COLLAPSE).addClass(p.COLLAPSING),
                                            ...
                                            0 < this._triggerArray.length && e(this._triggerArray).removeClass(p.COLLAPSED).attr("aria-expanded", !0),
        ...
        p = (function (e) {
            var t = "modal",
                ...
                _ = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean" },
                p = {
                    HIDE: "hide" + r,
                    HIDDEN: "hidden" + r,
                    SHOW: "show" + r,
                            ...
                            if (!(this._isTransitioning || this._isShown)) {
                                ...
                                e(this._element).trigger(o),
                                    this._isShown ||
                                        ...
                                        e(this._element).on(p.CLICK_DISMISS, g.DATA_DISMISS, function (e) {
                                            return n.hide(e);
                                        }),
                    ...
                    return (
                        ...
                        (h.toggle = function (t) {
                            if (this._isEnabled)
                                if (t) {
                                    ...
                                    o || ((o = new this.constructor(t.currentTarget, this._getDelegateConfig())), e(t.currentTarget).data(n, o)),
                        ...
                        (h.show = function () {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                e(r).data(this.constructor.DATA_KEY, this),
                                    e.contains(this.element.ownerDocument.documentElement, this.tip) || e(r).appendTo(_),
                        ...
                        (h.hide = function (t) {
                            var n = this,
                                ...
                                r = function () {
                                    n._hoverState !== m.SHOW && o.parentNode && o.parentNode.removeChild(o),
                                        n._cleanTipClass(),
                            ...
                            e(this.element).trigger(a),
                                a.isDefaultPrevented() ||
                                    ...
                                    l.supportsTransitionEnd() && e(this.tip).hasClass(f.FADE) ? e(o).one(l.TRANSITION_END, r).emulateTransitionEnd(150) : r(),
                                    (this._hoverState = ""));
                        }),
                        (h.update = function () {
                        ...
                        (h._enter = function (t, n) {
                            ...
                            n || ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())), e(t.currentTarget).data(o, n)),
                        ...
                        (h._getConfig = function (t) {
                            return (
                                (t = a({}, this.constructor.Default, e(this.element).data(), t)),
        ...
        g = (function (e) {
            var t = "popover",
                ...
                l = e.fn[t],
                s = /(^|\s)bs-popover\S+/g,
                d = a({}, m.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
                ...
                f = (function () {
                    function s(t, n) {
                        ...
                        (this._element = t),
                            ...
                            (this._config = this._getConfig(n)),
                            (this._selector = this._config.target + " " + m.NAV_LINKS + "," + (this._config.target + " " + m.LIST_ITEMS + ",") + (this._config.target + " " + m.DROPDOWN_ITEMS)),
                            (this._offsets = []),
                            (this._targets = []),
                    ...
                    return (
                        ...
                        (f._process = function () {
                            ...
                            for (var a, r = this._offsets.length; r--; )
                                (a = this._activeTarget !== this._targets[r] && e >= this._offsets[r] && ("undefined" == typeof this._offsets[r + 1] || e < this._offsets[r + 1])), a && this._activate(this._targets[r]);
                        }),
                        (f._activate = function (t) {
                            ...
                            o.hasClass(p.DROPDOWN_ITEM)
                                ? (o.closest(m.DROPDOWN).find(m.DROPDOWN_TOGGLE).addClass(p.ACTIVE), o.addClass(p.ACTIVE))
                                : (o.addClass(p.ACTIVE),
                                  o
                                      .parents(m.NAV_LIST_GROUP)
                                      .prev(m.NAV_LINKS + ", " + m.LIST_ITEMS)
                                      .addClass(p.ACTIVE),
                                  o.parents(m.NAV_LIST_GROUP).prev(m.NAV_ITEMS).children(m.NAV_LINKS).addClass(p.ACTIVE)),
        ...
        u = (function (e) {
            var t = "tab",
                ...
                a = "." + n,
                r = e.fn[t],
                i = { HIDE: "hide" + a, HIDDEN: "hidden" + a, SHOW: "show" + a, SHOWN: "shown" + a, CLICK_DATA_API: "click" + a + ".data-api" },
        ...
        A = (function (e) {
            var t = {
                ...
                n = { FORM_GROUP: "." + t.FORM_GROUP, BMD_FORM_GROUP: "." + t.BMD_FORM_GROUP, BMD_LABEL_WILDCARD: "label[class^='" + t.BMD_LABEL + "'], label[class*=' " + t.BMD_LABEL + "']" },
                o = {
                    validate: !1,
                ...
                a = { "form-control-lg": "bmd-form-group-lg", "form-control-sm": "bmd-form-group-sm" },
                i = (function (i) {
                    function l(t, n, a) {
                        var r;
                        return (
                        ...
                        (s.resolveMdbFormGroup = function () {
                            ...
                            return (
                                (void 0 === e || 0 === e.length) &&
                                    ...
                                    (e = this.findMdbFormGroup(this.config.bmdFormGroup.required))),
                                e
                            );
                        }),
                ...
                o = (function (o) {
                    ...
                    return (
                        ...
                        (i.rejectWithoutRequiredStructure = function () {
                            E.assert(this.$element, "label" === !this.$element.parent().prop("tagName"), this.constructor.name + "'s " + E.describe(this.$element) + " parent element should be <label>."),
                                E.assert(this.$element, !this.outerElement().hasClass(this.outerClass), this.constructor.name + "'s " + E.describe(this.$element) + " outer element should have class " + this.outerClass + ".");
                        }),
        ...
        I = (function (e) {
            var t = "checkbox",
                ...
                l = (function (o) {
                    function a(n, a, r) {
                        return void 0 === r && (r = { inputType: t, outerClass: t }), o.call(this, n, e.extend(!0, i, a), r) || this;
                    }
                    r(a, o);
                    var l = a.prototype;
                    return (
        ...
        T = (function (e) {
            var t = "checkboxInline",
                ...
                l = (function (t) {
                    function o(n, o, a) {
                        return void 0 === a && (a = { inputType: "checkbox", outerClass: "checkbox-inline" }), t.call(this, n, e.extend(!0, {}, i, o), a) || this;
                    }
                    r(o, t);
                    var a = o.prototype;
                    return (
            ...
            var t = "collapseInline",
                ...
                d = (function (t) {
                    function o(n, o) {
                        ...
                        var r = n.data("target");
                        (a.$collapse = e(r)),
                            E.assert(n, 0 === a.$collapse.length, "Cannot find collapse target for " + E.describe(n)),
                            E.assert(a.$collapse, !a.$collapse.hasClass(l.COLLAPSE), E.describe(a.$collapse) + " is expected to have the '" + l.COLLAPSE + "' class.  It is being targeted by " + E.describe(n));
                ...
                d = (function (t) {
                    ...
                    return (
                        ...
                        (a.rejectWithoutRequiredStructure = function () {
                            E.assert(this.$element, "label" === !this.outerElement().prop("tagName"), this.constructor.name + "'s " + E.describe(this.$element) + " parent element " + E.describe(this.outerElement()) + " should be <label>."),
                                E.assert(
                                    this.$element,
                                    !this.outerElement().hasClass(l.FILE),
                                    this.constructor.name + "'s " + E.describe(this.$element) + " parent element " + E.describe(this.outerElement()) + " should have class ." + l.FILE + "."
                                );
                        }),
        ...
        y = (function (e) {
            var t = "radioInline",
                ...
                l = (function (t) {
                    function o(n, o, a) {
                        return void 0 === a && (a = { inputType: "radio", outerClass: "radio-inline" }), t.call(this, n, e.extend(!0, {}, i, o), a) || this;
                    }
                    r(o, t);
                    var a = o.prototype;
                    return (
        ...
        v = (function (e) {
            var t = "switch",
                ...
                l = (function (t) {
                    function o(n, o, a) {
                        return void 0 === a && (a = { inputType: "checkbox", outerClass: "switch" }), t.call(this, n, e.extend(!0, {}, i, o), a) || this;
                    }
                    r(o, t);
                    var a = o.prototype;
                    return (
        ...
        L = (function (e) {
            ...
            var t = "dropdown",
                ...
                m = { DISABLED: "disabled", SHOW: "show", SHOWING: "showing", HIDING: "hiding", DROPUP: "dropup", MENURIGHT: "dropdown-menu-right", MENULEFT: "dropdown-menu-left" },
                g = { DATA_TOGGLE: '[data-toggle="dropdown"]', FORM_CHILD: ".dropdown form", MENU: ".dropdown-menu", NAVBAR_NAV: ".navbar-nav", VISIBLE_ITEMS: ".dropdown-menu .dropdown-item:not(.disabled)" },
                ...
                h = (function () {
                    ...
                    return (
                            ...
                            if (!(this._element.disabled || e(this._element).hasClass(m.DISABLED))) {
                                ...
                                if ((r._clearMenus(), !o)) {
                                    ...
                                    if ((e(n).trigger(i), !i.isDefaultPrevented())) {
                                        var l = this._element;
                                        e(n).hasClass(m.DROPUP) && (e(this._menu).hasClass(m.MENULEFT) || e(this._menu).hasClass(m.MENURIGHT)) && (l = n),
                                            (this._popper = new Popper(l, this._menu, this._getPopperConfig())),
                                            "ontouchstart" in document.documentElement && !e(n).closest(g.NAVBAR_NAV).length && e("body").children().on("mouseover", null, e.noop),
                                            this._element.focus(),
                                        ...
                                        l = function (o) {
                                            ...
                                            return (
                                                ...
                                                _.isDefaultPrevented()
                                                    ? "continue"
                                                    : void (("ontouchstart" in document.documentElement) && e("body").children().off("mouseover", null, e.noop),
                        ...
                        (r._dataApiKeydownHandler = function (t) {
                            if (
                                !(!_.test(t.which) || (/button/i.test(t.target.tagName) && t.which === d) || /input|textarea/i.test(t.target.tagName)) &&
                                (t.preventDefault(), t.stopPropagation(), !(this.disabled || e(this).hasClass(m.DISABLED)))
                            ) {
        ...
        U = (function (e) {
            var t = { CANVAS: "bmd-layout-canvas", CONTAINER: "bmd-layout-container", BACKDROP: "bmd-layout-backdrop" },
                n = { CANVAS: "." + t.CANVAS, CONTAINER: "." + t.CONTAINER, BACKDROP: "." + t.BACKDROP },
                o = { canvas: { create: !0, required: !0, template: '<div class="' + t.CANVAS + '"></div>' }, backdrop: { create: !0, required: !0, template: '<div class="' + t.BACKDROP + '"></div>' } },
                a = (function (t) {
                    function a(n, a, r) {
                        var i;
        ...
        P = (function (e) {
            var t = "drawer",
                ...
                a = e.fn[o],
                i = { ESCAPE: 27 },
                l = { IN: "in", DRAWER_IN: "bmd-drawer-in", DRAWER_OUT: "bmd-drawer-out", DRAWER: "bmd-layout-drawer", CONTAINER: "bmd-layout-container" },
                ...
                d = (function (t) {
                    function o(n, o) {
                        ...
                        return (
                            ...
                            (a.$toggles = e('[data-toggle="drawer"][href="#' + a.$element[0].id + '"], [data-toggle="drawer"][data-target="#' + a.$element[0].id + '"]')),
                            a._addAria(),
                            a.$backdrop
                                .keydown(function (e) {
                    ...
                    return (
                        ...
                        (a.hide = function () {
                            this._isOpen() &&
                                (this.$toggles.attr("aria-expanded", !1), this.$element.attr("aria-expanded", !1), this.$element.attr("aria-hidden", !0), this.$container.removeClass(l.DRAWER_IN), this.$backdrop.removeClass(l.IN));
                        }),
                        (a._isOpen = function () {
                ...
                d = (function () {
                    ...
                    return (
                        ...
                        (o._onStartRipple = function (e) {
                            ...
                            if (!(this._isTouch() && "mousedown" === e.type)) {
                                ...
                                var n = this._getRelY(e),
                                    o = this._getRelX(e);
                                (n || o) &&
                                    (this.$decorator.css({ left: o, top: n, "background-color": this._getRipplesColor() }),
                        ...
                        (o._findOrCreateContainer = function () {
                            (!this.$container || 0 < !this.$container.length) && (this.$element.append(this.config.container.template), (this.$container = this.$element.find(l.CONTAINER))),
                        ...
                        (o.rippleOn = function () {
                            ...
                            E.transitionEndSupported()
                                ? this.$decorator
                                      .css({ "-ms-transform": "scale(" + t + ")", "-moz-transform": "scale(" + t + ")", "-webkit-transform": "scale(" + t + ")", transform: "scale(" + t + ")" })
                                      .addClass("ripple-on")
                                      .data("animating", "on")
                                      .data("mousedown", "on")
