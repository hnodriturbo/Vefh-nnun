...
!(function (a) {
    ...
    function Y(a, e, g) {
        ...
        function O(a, b) {
            ...
            (wa = f.concat(g, h)),
                a.cursor && ((za.style.cursor = getComputedStyle(a.target).cursor), ia.length > 1 && l(pa, e.cssClasses.drag), za.addEventListener("selectstart", c, !1)),
                b.handleNumbers.forEach(function (a) {
                    K("start", a);
                });
        }
        function P(a) {
            ...
            return c === !1
                ? !1
                : (e.events.snap || h(pa, e.cssClasses.tap, e.animationDuration), W(c, b, !0, !0), V(), K("slide", c, !0), K("update", c, !0), K("change", c, !0), K("set", c, !0), void (e.events.snap && O(a, { handleNumbers: [c] })));
        }
        function Q(a) {
            var b = H(a.calcPoint),
                c = ta.getStep(b),
        ...
        function S(a, b, c, d, f, g) {
            return (
                ia.length > 1 && (d && b > 0 && (c = Math.max(c, a[b - 1] + e.margin)), f && b < ia.length - 1 && (c = Math.min(c, a[b + 1] - e.margin))),
                ia.length > 1 && e.limit && (d && b > 0 && (c = Math.min(c, a[b - 1] + e.limit)), f && b < ia.length - 1 && (c = Math.max(c, a[b + 1] - e.limit))),
                e.padding && (0 === b && (c = Math.max(c, e.padding)), b === ia.length - 1 && (c = Math.min(c, 100 - e.padding))),
                (c = ta.getStep(c)),
                (c = i(c)),
                c !== a[b] || g ? c : !1
            );
