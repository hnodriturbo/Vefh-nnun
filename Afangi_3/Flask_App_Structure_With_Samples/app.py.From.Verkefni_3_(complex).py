...
def homepage():
    all_data = {}
    for category, details in accordion_categories.items():
        
        carousel_data = []
        
        for link in details['links']:
            item_type = link['args'].get('item_type', 'N/A')
            category_name = link['args'].get('category', 'N/A')
            carousel_data.append((category, item_type, category_name))
            
        return render_template('index.html', carousels_data=carousel_data)   
